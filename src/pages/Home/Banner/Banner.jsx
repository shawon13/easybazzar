            ...
            <div className="container mx-auto px-4 flex items-center h-full">
                <div className='w-3/4 pl-20'>
                    ...
                    <div className='flex items-center'>
                        <p className='text-xl uppercase font-bold mr-2'>{p_title}</p>
                        <FaBangladeshiTakaSign className='text-xl ml-2' />
                        <span className='text-4xl'>{price}</span>
                        <sup className='text-sm'>{sub_price}</sup>
                    </div>
                    <div className='mt-8'>
                        <Link style={{ color: '#fff' }} className='px-8 py-4 bg-black hover:text-white text-white uppercase font-bold'>Shop Now</Link>
                    </div>
                </div>
