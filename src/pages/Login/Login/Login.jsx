    ...
    return (
        <section className='py-10'>
            <div className='container mx-auto w-1/2 px-4'>
                ...
                <div className='bg-white flex justify-center pt-6 pb-12 pl-6 pr-6 rounded-md'>
                    <div className='w-4/5 mr-5'>
                        <form action="" onSubmit={handleLogin}>
                            ...
                            <div className='relative'>
                                ...
                                <input className='border w-full py-2.5 px-2.5' type={type} name="" id="" placeholder='Please enter your password' />
                                {
                        ...
                        <div className='flex justify-center items-center'>
                            <span style={{ backgroundColor: '#3b5998' }} className='rounded-full w-10 h-10 p-2.5 mr-2.5 text-white text-center cursor-pointer'>
                                <FaFacebookF className='text-xl mr-3' />
                            </span>
                            <span style={{ backgroundColor: '#d34836' }} className='rounded-full w-10 h-10 p-2.5 mr-2.5 text-white text-center cursor-pointer'>
                                <FaGooglePlusG className='text-2xl mr-3' />
                            </span>
                            <span className='rounded-full w-10 h-10 p-2.5 mr-2.5 bg-black text-white text-center cursor-pointer'>
