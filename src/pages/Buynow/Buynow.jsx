...
const Buynow = () => {
    ...
    const cartQuantity = cartProduct?.reduce((sum, item) => sum + item.quantity, 0)

    //item total
    const itemTotal = product ? product.current_price * quantity : cartProduct.reduce((sum, item) => sum + item.current_price * item.quantity, 0)
                    ...
                    <div style={{ width: '30%' }} className=' bg-white px-5 py-6 shadow-md rounded-md h-96'>
                        ...
                        <div className='mt-3'>
                            ...
                            <div className='flex items-center mt-3.5'>
                                <input type="text" name="" id="" className='w-full border border-r-0 py-2 px-2.5 outline-none border-gray-200' placeholder='Enter Code' />
                        ...
                        <div>
                            ...
                            <div className='flex items-center justify-between my-2'>
                                <h4 className='text-base font-normal text-black capitalize'>items Total ({product ? quantity : cartQuantity} items)</h4>
                                <div className='flex items-center justify-between'>
                            ...
                            <div className='text-center mt-5'>
                                <Link style={{ color: '#fff' }} className='bg-orange capitalize font-normal block w-full py-2 text-sm'>place order</Link>
                            </div>
                        </div>
                    </div>
                </div>
